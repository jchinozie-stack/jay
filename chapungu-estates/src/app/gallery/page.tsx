  ...
  return (
    <>
      ...
      <section className="relative h-[45vh] flex items-center justify-center bg-stone-950 overflow-hidden">
        ...
        >
          {[
            <p key="label" className="section-label text-gold/80 mb-4">Visual Story</p>,
            <h1 key="title" className="font-display text-5xl md:text-7xl font-light">Gallery</h1>,
            <p key="sub" className="mt-4 text-stone-300 text-lg max-w-xl mx-auto">
      ...
      <section className="sticky top-20 z-30 px-4 md:px-8 py-2">
        <div className="container-site">
          <motion.div
            className="liquid-glass bg-charcoal/55 rounded-full px-2 py-2 flex gap-1 overflow-x-auto scrollbar-hide"
          ...
          <motion.div layout className="columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4">
            ...
            {filtered.map((item, i) => (
              <motion.button
                ...
                transition={{ duration: 0.55, ease: luxuryEase, delay: Math.min(i * 0.05, 0.4) }}
                className="w-full break-inside-avoid block overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 group cursor-zoom-in"
