    ...
    <section id="story" className="py-32 lg:py-40 bg-earth-950 overflow-hidden" aria-labelledby="story-heading">
      <div className="container-site">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <Reveal direction="right" className="relative h-[600px] lg:h-[700px] order-2 lg:order-1" amount={0.2}>
            ...
            <div className="absolute bottom-12 left-8 bg-brand-500 p-6 text-white">
              <div className="font-display text-5xl font-light leading-none"><CountUp value="10+" /></div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <Stagger className="grid grid-cols-3 gap-6 mt-12 pt-12 border-t border-earth-800" interval={0.12}>
              {[
                ...
                <StaggerItem key={label}>
                  <div className="font-display text-3xl text-white font-light"><CountUp value={value} delay={i * 0.12} /></div>
